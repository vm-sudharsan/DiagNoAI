...
import { DiseaseType, DiabetesData, HeartDiseaseData, StrokeData, ParkinsonsData } from '../types/disease';
...
interface PredictionResultProps {
  ...
  probability?: number;
  message: string;
  inputData: DiabetesData | HeartDiseaseData | StrokeData | ParkinsonsData;
}
